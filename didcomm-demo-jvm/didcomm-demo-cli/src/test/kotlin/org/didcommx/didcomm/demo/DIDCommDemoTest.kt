...
import org.didcommx.didcomm.demo.DIDCommDemo.Companion.resolvePeerDID
...
class DIDCommDemoTest {
    ...
    private fun checkExpectedDIDDoc(
        ...
        service_endpoint: String? = null, service_routing_keys: List<String> = emptyList()
    ) {
    ...
    fun testResolvePeerDID() {
        ...
        val didDocJson = DIDCommDemo.resolvePeerDID(did, format = VerificationMaterialFormatPeerDID.JWK)
